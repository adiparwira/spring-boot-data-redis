...
public class ProgrammerRepositoryImpl implements ProgrammerRepository {
	...
	public void AddToProgrammersSet(Programmer... programmers) {
		this.setOps.add(REDIS_SET_KEY, programmers);
	}

	@Override
	public Set<Programmer> getProgrammersSetMembers() {
		return this.setOps.members(REDIS_SET_KEY);
	}

	@Override
	public boolean isSetMember(Programmer programmer) {
		return this.setOps.isMember(REDIS_SET_KEY, programmer);
	}

	@Override
	public void saveHash(Programmer programmer) {
		this.hashOps.put(REDIS_HASH_KEY, programmer.getId(), programmer);
	...
	public Map<Integer, Programmer> findAllHash() {
		return this.hashOps.entries(REDIS_HASH_KEY);
	}

	@Override
	public Programmer findInHash(int id) {
		return this.hashOps.get(REDIS_HASH_KEY, id);
	}

	@Override
	public void deleteHash(int id) {
		this.hashOps.delete(REDIS_HASH_KEY, id);
	}
